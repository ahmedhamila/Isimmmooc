# Generated by Django 4.1.2 on 2023-01-15 20:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('video', models.FileField(help_text='Short Video du Cours', null=True, upload_to='Cours_videos/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['MOV', 'avi', 'mp4', 'webm', 'mkv'])])),
            ],
            options={
                'ordering': ['-video'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapitre', models.OneToOneField(default=None, help_text='Chapitre associe', on_delete=django.db.models.deletion.CASCADE, to='Isimmmooc_App.chapitre')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_video', models.OneToOneField(default=None, help_text='Video associe', on_delete=django.db.models.deletion.CASCADE, to='Isimmmooc_App.coursvideo')),
            ],
        ),
        migrations.AddField(
            model_name='chapitre',
        ...
        migrations.AddField(
            model_name='chapitre',
            name='video',
            field=models.OneToOneField(default=None, help_text='Video associe', on_delete=django.db.models.deletion.CASCADE, to='Isimmmooc_App.chapitrevideo'),
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('question', models.ForeignKey(default=None, help_text='Question relative', on_delete=django.db.models.deletion.CASCADE, to='Isimmmooc_App.question')),
            ],
            options={
