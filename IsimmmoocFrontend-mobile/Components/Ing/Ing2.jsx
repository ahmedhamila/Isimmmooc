...
const Ing2 = ({navigation}) => {
  

const [courses,setCourses]=useState([

  {name:"Cours Machine Learning",image:require("../../assets/images/mal.jpg"),
  rate:require("../../assets/images/4.png")},
  {name:"Cours Art", image:require("../../assets/images/art.jpg"),
  rate:require("../../assets/images/4.png")},
  {name:"Cours proba", image:require("../../assets/images/prob.jpg"),
...
<Text style={styles.pop} >Cours Ing 2 </Text>
