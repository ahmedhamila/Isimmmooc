...
const [courses,setCourses]=useState([
    {name:"Cours Algebre", image:require("../../../assets/images/cal.jpg"),
    rate:require("../../../assets/images/4.png")
   },
  {name:"Cours geometrie",image:require("../../../assets/images/gm.jpg"),
  rate:require("../../../assets/images/5.png")},
  {name:"Cours Static", image:require("../../../assets/images/m.jpg"),
  rate:require("../../../assets/images/0.png")},
  {name:"Cours geometrie", image:require("../../../assets/images/alg.jpg"),
  rate:require("../../../assets/images/4.png")},
...
<Text style={styles.pop} >Cours Maths 3 </Text>
