...
const [courses,setCourses]=useState([
    {name:"Cours mobile", image:require("../../../assets/images/prog.jpg"),
    rate:require("../../../assets/images/4.png")
   },

   {name:"Cours python", image:require("../../../assets/images/pyth.jpg"),
   rate:require("../../../assets/images/5.png")},
   {name:"Cours art",image:require("../../../assets/images/mal.jpg"),
   rate:require("../../../assets/images/4.png")},
...
<Text style={styles.pop} >Cours Info 3 </Text>
