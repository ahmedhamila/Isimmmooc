...
const [courses,setCourses]=useState([
    {name:"Cours mobile", image:require("../../../assets/images/mob.jpg"),
    rate:require("../../../assets/images/4.png")
   },

   {name:"Cours machine learning", image:require("../../../assets/images/ML.jpg"),
   rate:require("../../../assets/images/3s.png")},
   {name:"Cours web", image:require("../../../assets/images/comp.jpg"),
   rate:require("../../../assets/images/2s.png")},
  {name:"Cours anglais",image:require("../../../assets/images/eng.jpg"),
  rate:require("../../../assets/images/4.png")},
...
<Text style={styles.pop} >Cours Info 1 </Text>
