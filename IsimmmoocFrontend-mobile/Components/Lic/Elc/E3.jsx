...
const [courses,setCourses]=useState([
   ...
   {name:"Cours Elctro", image:require("../../../assets/images/volt.jpg"),
   rate:require("../../../assets/images/0.png")},
   {name:"Cours Reseau", image:require("../../../assets/images/elc.jpg"),
   rate:require("../../../assets/images/4.png")},
   {name:"Cours Arduino",image:require("../../../assets/images/ard.jpg"),
...
<Text style={styles.pop} >Cours Elc 3 </Text>
