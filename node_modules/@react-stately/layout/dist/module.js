import $gtW1T$swchelperssrc_define_propertymjs from "@swc/helpers/src/_define_property.mjs";
...
class $61ef60fc9b1041f4$export$cacbb3924155d68e extends (0, $gtW1T$Layout) {
    ...
    buildCollection() {
        ...
        if (nodes.length === 0) {
            ...
            let rect1 = new (0, $gtW1T$Rect)(0, y, this.virtualizer.visibleRect.width, (_this_placeholderHeight = this.placeholderHeight) !== null && _this_placeholderHeight !== void 0 ? _this_placeholderHeight : this.virtualizer.visibleRect.height);
            let placeholder = new (0, $gtW1T$LayoutInfo)("placeholder", "placeholder", rect1);
   ...
   */ constructor(options = {}){
        super();
        (0, $gtW1T$swchelperssrc_define_propertymjs)(this, "disabledKeys", new Set());
        (0, $gtW1T$swchelperssrc_define_propertymjs)(this, "allowDisabledKeyFocus", false);
...
class $a152112e902709bf$export$62444c3c724b1b20 extends (0, $61ef60fc9b1041f4$export$cacbb3924155d68e) {
    ...
    buildBody(y) {
        ...
        if (this.isLoading) {
            ...
            let rect1 = new (0, $gtW1T$Rect)(40, Math.max(y, 40), (width || this.virtualizer.visibleRect.width) - 80, children.length === 0 ? this.virtualizer.visibleRect.height - 80 : 60);
            let loader = new (0, $gtW1T$LayoutInfo)("loader", "loader", rect1);
            ...
            let rect2 = new (0, $gtW1T$Rect)(40, Math.max(y, 40), this.virtualizer.visibleRect.width - 80, this.virtualizer.visibleRect.height - 80);
            let empty = new (0, $gtW1T$LayoutInfo)("empty", "empty", rect2);
    ...
    constructor(options){
        ...
        (0, $gtW1T$swchelperssrc_define_propertymjs)(this, "wasLoading", false);
        (0, $gtW1T$swchelperssrc_define_propertymjs)(this, "isLoading", false);
        (0, $gtW1T$swchelperssrc_define_propertymjs)(this, "lastPersistedKeys", null);
        (0, $gtW1T$swchelperssrc_define_propertymjs)(this, "persistedIndices", new Map());
